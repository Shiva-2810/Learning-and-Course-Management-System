...
export const searchCourse = async (req,res) => {
    try {
        ...
        const searchCriteria = {
            isPublished:true,
            $or:[
                {courseTitle: {$regex:query, $options:"i"}}, //regex means partial match
        ...
        if(sortByPrice === "low"){
            ...
            //search for specified course in Course model populating with name and photourl of creator and sorting it on basis of coursePrice
